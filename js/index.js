...
function run() {
    ...
    Q.all(getFiles)
        ...
        var referenceParser = new referenceParser_1.ReferenceParser(files, new RegExp(config.commentRegExp), new RegExp(config.anchorRegExp), new RegExp(config.longCommentOpenRegExp), new RegExp(config.longCommentCloseRegExp), config.outputDir);
